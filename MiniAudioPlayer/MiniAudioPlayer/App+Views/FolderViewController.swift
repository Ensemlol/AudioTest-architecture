...
class FolderViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(FolderViewController.handleChangeNotification(_:)), name: Store.changedNotification, object: nil)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let idemtifier = item is Recording ? "RecordingItem" : "FolderItem"
        let cell = tableView.dequeueReusableCell(withIdentifier: idemtifier, for: indexPath)
